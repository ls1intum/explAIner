 ...
 *              (e.g. useAppDispatch = hook to send an action from the component to the store)
 ...
 * (2) UI component calls dispatch(someAction()) <- using hook "useAppDispatch"
 ...
 * (5) UI component re-renders with new state <- using hook "useAppSelector"
 */
