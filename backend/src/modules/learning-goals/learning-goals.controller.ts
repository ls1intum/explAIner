...
export class LearningGoalsController {
  ...
  @ApiResponse({ status: 201, description: 'Learning goals generated successfully', type: GenerateLearningGoalsResponseDto })
  ...
  @ApiResponse({ status: 201, description: 'Easier learning goals generated successfully', type: GenerateEasierLearningGoalsResponseDto })
